...
-- 3100			Pieter Breughelstraat 837	Utrecht				Utrecht		

use AVI;
create Table countries(country_id varchar(50) primary key, country_name varchar(50),region_id int);
create Table locations(location_id int, street_address varchar(50),postal_code varchar(50), city varchar(50),state_province varchar(50),country_id varchar(50),
...
select count(country_name) from
(select locations.location_id,locations.street_address,locations.city,locations.state_province, countries.country_name
from  locations JOIN countries ON locations.country_id = countries.country_id order by locations.location_id asc) as newCat ;